...
object DataCollectorActor extends ActorModule with LazyLogging {
  ...
  @Provides
  def apply (implicit serialPortsActor: ActorRef[SerialPortsActor.Message], @Named("vizRc210.memoryFile") sMemoryFile: String, executionContext: ExecutionContext): Behavior[Message] = {
