...
object FieldDefinitions {
  ...
  val fields: Seq[FieldMetadata] = Seq(
    ...
    (47, "Mute Digit Select", commonKey, "*2090v") % SelectOptions.dtmfMuteDigit,
    (48, "CTCSS During ID", portKey, "*n2089") % checkBox,
    (54, "Timeout Ports", commonKey, "*2051b") % checkBox,
    (55, "Speech Delay", commonKey, "*1019v") % UiNumber(600, "Seconds"),
    ...
    (1176, "Radio Type", commonKey, "n*2083 v") % radioType,
    (1176, "Yaesu Type", commonKey, "n*2084 v") % yaesuType,
    (1177, "Fan Timeout", commonKey, "n*1004v") % UiNumber(255, "Minutes"),
    //DTMFRegenPrefix1 - 1179-1185 need  special handling. part of IRLP stuff.
    (1186, "Clock 24 Hours", commonKey, "n*5103") % checkBox,
    (1187, "Fan Select", commonKey, "n*2119b") % checkBox,
    (1188, "DTMF Duration", commonKey, "n*2106b") % checkBox,
    (1189, "DTMF Pause", commonKey, "n*2107b") % checkBox,
    //DTMFStrings - 1190-1409 special handling
    //DVRSecondLow - 1410-1473
    //DVRTrack - 1474-1493
    //DVRRowsUsed - 1494-1533
    (1534, "Allow Terminator Speech", commonKey, "n*2091b") % checkBox,
    //RemoteRadioMode - 1535-1544
    (1534, "AutoPatch Port", commonKey, "n*2116v") % checkBox,
    (1534, "AutoPatch Port Mute", commonKey, "n270") % checkBox,
    //GeneralTimers1_3 - 1553-1558
    //GeneralTimers4_6 - 1559-1564
    //GeneralTimer1_3Macro - 1565-1567
    //GeneralTimer4_6Macro - 1568-1570
    (1571, "Program Prefix", commonKey, "n*2109") % UiDtmf(4),
    ...
    (3531, "Lock Code", commonKey, "n*9010v") % UiDtmf(4),
    (3536, "Terminator", commonKey, "n9020v") % UiDtmf(1),
    ...
    (3540, "Say Year", commonKey, "n*5102b") % checkBox,
